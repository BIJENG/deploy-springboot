<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        <a class="navbar-brand" href="http://localhost:9090/user/index2">술주정</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink1">
                        ...
                        <li><a class="dropdown-item" href="http://localhost:9090/board/list">자랑하酒</a></li>
                        <li><a class="dropdown-item" href="http://localhost:9090/board/trade">거래하酒</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink3">
                        <li><a class="dropdown-item" href="http://localhost:9090/chatPage">Chat酒PT</a></li>
                        <li><a class="dropdown-item" href="http://localhost:9090/board/searchResult">검색하酒</a></li>
                    </ul>
                </li>
            </ul>
